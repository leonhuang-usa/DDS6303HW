...
plot(x=airquality$Month, y=Temperature,xlabel="Month", ylabel="Temperature", main="Temperature by Month")
...
plot(x= Temperature, y= Ozone, xlabel="Temperature", ylabel="Ozone", main="Temperature vs Ozone")
